...
local be_friends = function(force_1, force_2) -- TODO: Could be useful for allowing the Hivemind to "Recruit" Neutral bases.
...
local get_hivemind_force = function(player) -- TODO: Use this to update the popcap of a force when it has multiple players!
...
create_hivemind_force = function(player) -- TODO: Ultimately replace this to allow players to pick and choose which team they want to join
  local force
...
convert_nest = function(player, spawner) -- TODO: Might be usable to convert neutral bases to your cause
  local surface = player.surface
...
local join_hive
local leave_hive
-- TODO: Fix this to allow more dynamic team adjustments!
local actions =
{
