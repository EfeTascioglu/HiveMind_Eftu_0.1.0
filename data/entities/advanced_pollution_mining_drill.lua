local name = names.advanced_pollution_mining_drill

local id = "Advanced Pollution Mining Drill"
...
local item =
{
  ...
  name = name,
  localised_name = {name},
  localised_description = {"requires-pollution-can-mine-ressources", names.required_pollution[name] * names.pollution_cost_multiplier, "coal, iron, copper, stone, or uranium"},
  icons = drill.icons,
  icon = drill.icon,
  icon_size = drill.icon_size,
  flags = {},
